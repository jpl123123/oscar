...
| `DESIGN-20260904-E-oscar-x2-packed-slot.md` | 设计提案：`--kv-cache-dtype int8_per_token_head` 通道实现 ×2 FULL 密度（1,536 token/页、三大条同构、零源码改动；MTP 影子池解唯一硬约束） | DESIGN PROPOSAL | 页几何/视图/记账逐行核验；决策点 = MTP 方案 A/B |
